...
import Location from './js/components/pages/location'
import Orders from './js/components/pages/orders'
					...
					<ScrollContext>
						<Switch>
                            ...
                            <Layout>
                                ...
                                <Route path={`${process.env.PUBLIC_URL}/pages/location`} component={Location}/>
                                <Route path={`${process.env.PUBLIC_URL}/pages/orders`} component={Orders}/>
